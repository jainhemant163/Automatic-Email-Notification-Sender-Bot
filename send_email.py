...
email_sender_account = "xxxx" #your email

email_sender_username = "xxxx"  #your email username

email_sender_password = "xxxxx"#your email password

email_smtp_server = "smtp.gmail.com" #change if not gmail.

email_smtp_port = 587 #change if needed.

email_recepients = ["xxxx","xxx"] #your receipts
